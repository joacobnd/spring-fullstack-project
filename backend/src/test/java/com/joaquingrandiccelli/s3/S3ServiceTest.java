package com.joaquingrandiccelli.s3;
...
class S3ServiceTest {
    ...
    void canPutObject() throws IOException {
        ...
        assertThat(putObjectRequestArgumentCaptorValue.bucket().equals(bucket));
        assertThat(putObjectRequestArgumentCaptorValue.key().equals(key));
