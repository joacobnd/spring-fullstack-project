...
import {updateCustomer, uploadCustomerProfilePicture, customerProfilePictureUrl} from "../../services/client.jsx";
...
const MyDropzone = ({customerId, fetchCustomers}) => {
    const onDrop = useCallback(acceptedFiles => {
        ...
        uploadCustomerProfilePicture(
            ...
            errorNotification("Error", "Profile picture fail to upload");
        })
    }, [])
        ...
        >
            <input {...getInputProps()} />
            {
                isDragActive ?
                    ...
                    <p>Drag 'n' drop your picture here, or click to select files</p>
            }
        </Box>
    )
}
